...
public struct LabelToken: View {
    ...
    private var backgroundColor: Color {
        switch state {
        case .idle:
            return ColorPalette.surface.swiftUIColor.opacity(0.85)
        case .incorrect:
            return ColorPalette.accent.swiftUIColor.opacity(0.85)
        case .placed:
            return ColorPalette.primary.swiftUIColor.opacity(0.2)
        }
    }
    ...
    private var borderColor: Color {
        ...
        case .placed:
            return ColorPalette.primary.swiftUIColor.opacity(0.4)
        }
    }
    ...
    private var foregroundColor: Color {
        ...
        case .incorrect:
            return Color.white
        case .placed:
            return ColorPalette.primary.swiftUIColor.opacity(0.8)
        }
    }
}
